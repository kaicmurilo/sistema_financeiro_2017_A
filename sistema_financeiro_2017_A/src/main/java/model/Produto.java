...
public class Produto {
	...
	public void setQtdestoque(double qtdestoque2) {
		this.qtdestoque = qtdestoque2;
	}
	public double getQtdminestoque() {
		return qtdminestoque;
	}
	public void setQtdminestoque(double qtdminestoque2) {
		this.qtdminestoque = qtdminestoque2;
	}
